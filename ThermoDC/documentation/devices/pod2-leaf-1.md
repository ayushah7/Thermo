...
| --------- | --------------- | ------------ | --------- |
| POD2_MLAG01 | Vlan4094 | 10.255.1.73 | Port-Channel49 |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 100.100.0.71/32 |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 100.100.0.71:10011 | 10011:10011 | - | - | learned |
| 12 | 100.100.0.71:10012 | 10012:10012 | - | - | learned |
| 21 | 100.100.0.71:10021 | 10021:10021 | - | - | learned |
| 22 | 100.100.0.71:10022 | 10022:10022 | - | - | learned |
| 3401 | 100.100.0.71:13401 | 13401:13401 | - | - | learned |
| 3402 | 100.100.0.71:13402 | 13402:13402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| VRF10 | 100.100.0.71:10 | connected | - |
| VRF11 | 100.100.0.71:11 | connected | - |
...
router bgp 65103
   ...
   neighbor 10.255.1.105 description pod2-leaf-2_Vlan4093
   ...
   !
   vlan 11
      rd 100.100.0.71:10011
      route-target both 10011:10011
      redistribute learned
   !
   vlan 12
      rd 100.100.0.71:10012
      route-target both 10012:10012
      redistribute learned
   !
   vlan 21
      rd 100.100.0.71:10021
      route-target both 10021:10021
      redistribute learned
   !
   vlan 22
      rd 100.100.0.71:10022
      route-target both 10022:10022
      redistribute learned
   !
   vlan 3401
      rd 100.100.0.71:13401
      route-target both 13401:13401
      redistribute learned
   !
   vlan 3402
      rd 100.100.0.71:13402
   ...
   vrf VRF10
      ...
      router-id 100.100.0.71
      neighbor 10.255.1.105 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.105 description pod2-leaf-2_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 100.100.0.71
      neighbor 10.255.1.105 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.105 description pod2-leaf-2_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
