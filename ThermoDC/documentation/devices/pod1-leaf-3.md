...
| --------- | --------------- | ------------ | --------- |
| POD1_MLAG02 | Vlan4094 | 10.255.1.5 | Port-Channel49 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | MLAG_pod1-leaf-4_Ethernet49 | *trunk | *- | *- | *MLAG | 49 |
| Ethernet50 | MLAG_pod1-leaf-4_Ethernet50 | *trunk | *- | *- | *MLAG | 49 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_pod1-spine-1_Ethernet5 | - | 10.255.255.9/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_pod1-spine-2_Ethernet5 | - | 10.255.255.11/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_pod1-spine-1_Ethernet5
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_pod1-spine-2_Ethernet5
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet49
   description MLAG_pod1-leaf-4_Ethernet49
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description MLAG_pod1-leaf-4_Ethernet50
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | MLAG_pod1-leaf-4_Port-Channel49 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel49
   description MLAG_pod1-leaf-4_Port-Channel49
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 100.100.0.3/32 |
...
| Vlan3009 |  VRF10  |  10.255.1.36/31  |  -  |  -  |  -  |  -  |
| Vlan3010 |  VRF11  |  10.255.1.36/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.1.36/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.1.37 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.255.8 | 65150 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.255.10 | 65150 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.255.1.37 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.1.37 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 100.100.0.3:10011 | 10011:10011 | - | - | learned |
| 12 | 100.100.0.3:10012 | 10012:10012 | - | - | learned |
| 21 | 100.100.0.3:10021 | 10021:10021 | - | - | learned |
| 22 | 100.100.0.3:10022 | 10022:10022 | - | - | learned |
| 3401 | 100.100.0.3:13401 | 13401:13401 | - | - | learned |
| 3402 | 100.100.0.3:13402 | 13402:13402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| VRF10 | 100.100.0.3:10 | connected | - |
| VRF11 | 100.100.0.3:11 | connected | - |
...
router bgp 65102
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description pod1-leaf-4
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER password 7 <removed>
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 10.255.1.37 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.1.37 description pod1-leaf-4_Vlan4093
   neighbor 10.255.255.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.8 remote-as 65150
   neighbor 10.255.255.8 description pod1-spine-1_Ethernet5
   neighbor 10.255.255.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.10 remote-as 65150
   neighbor 10.255.255.10 description pod1-spine-2_Ethernet5
   ...
   !
   vlan 11
      rd 100.100.0.3:10011
      route-target both 10011:10011
      redistribute learned
   !
   vlan 12
      rd 100.100.0.3:10012
      route-target both 10012:10012
      redistribute learned
   !
   vlan 21
      rd 100.100.0.3:10021
      route-target both 10021:10021
      redistribute learned
   !
   vlan 22
      rd 100.100.0.3:10022
      route-target both 10022:10022
      redistribute learned
   !
   vlan 3401
      rd 100.100.0.3:13401
      route-target both 13401:13401
      redistribute learned
   !
   vlan 3402
      rd 100.100.0.3:13402
   ...
   vrf VRF10
      ...
      router-id 100.100.0.3
      neighbor 10.255.1.37 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.37 description pod1-leaf-4_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 100.100.0.3
      neighbor 10.255.1.37 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.37 description pod1-leaf-4_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
