...
| --------- | --------------- | ------------ | --------- |
| POD2_MLAG01 | Vlan4094 | 10.255.1.72 | Port-Channel49 |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 100.100.0.72/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.100.1.71/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 100.100.0.72/32
!
interface Loopback1
   description VXLAN_TUNNEL_SOURCE
   no shutdown
   ip address 10.100.1.71/32
!
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 100.100.0.72:10011 | 10011:10011 | - | - | learned |
| 12 | 100.100.0.72:10012 | 10012:10012 | - | - | learned |
| 21 | 100.100.0.72:10021 | 10021:10021 | - | - | learned |
| 22 | 100.100.0.72:10022 | 10022:10022 | - | - | learned |
| 3401 | 100.100.0.72:13401 | 13401:13401 | - | - | learned |
| 3402 | 100.100.0.72:13402 | 13402:13402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| VRF10 | 100.100.0.72:10 | connected | - |
| VRF11 | 100.100.0.72:11 | connected | - |
...
router bgp 65103
   ...
   neighbor 10.255.1.104 description pod2-leaf-1_Vlan4093
   ...
   !
   vlan 11
      rd 100.100.0.72:10011
      route-target both 10011:10011
      redistribute learned
   !
   vlan 12
      rd 100.100.0.72:10012
      route-target both 10012:10012
      redistribute learned
   !
   vlan 21
      rd 100.100.0.72:10021
      route-target both 10021:10021
      redistribute learned
   !
   vlan 22
      rd 100.100.0.72:10022
      route-target both 10022:10022
      redistribute learned
   !
   vlan 3401
      rd 100.100.0.72:13401
      route-target both 13401:13401
      redistribute learned
   !
   vlan 3402
      rd 100.100.0.72:13402
   ...
   vrf VRF10
      ...
      router-id 100.100.0.72
      neighbor 10.255.1.104 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.104 description pod2-leaf-1_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 100.100.0.72
      neighbor 10.255.1.104 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.104 description pod2-leaf-1_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
