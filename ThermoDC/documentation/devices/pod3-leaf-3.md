...
| --------- | --------------- | ------------ | --------- |
| POD3_MLAG02 | Vlan4094 | 10.255.1.149 | Port-Channel49 |
...
!
mlag configuration
   domain-id POD3_MLAG02
   local-interface Vlan4094
   peer-address 10.255.1.149
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | MLAG_pod3-leaf-4_Ethernet49 | *trunk | *- | *- | *MLAG | 49 |
| Ethernet50 | MLAG_pod3-leaf-4_Ethernet50 | *trunk | *- | *- | *MLAG | 49 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_pod3-spine-1_Ethernet13 | - | 10.255.253.41/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_pod3-spine-2_Ethernet13 | - | 10.255.253.43/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_pod3-spine-1_Ethernet13
   no shutdown
   mtu 1500
   no switchport
   ip address 10.255.253.41/31
!
interface Ethernet2
   description P2P_pod3-spine-2_Ethernet13
   no shutdown
   mtu 1500
   no switchport
   ip address 10.255.253.43/31
!
interface Ethernet49
   description MLAG_pod3-leaf-4_Ethernet49
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description MLAG_pod3-leaf-4_Ethernet50
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | MLAG_pod3-leaf-4_Port-Channel49 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel49
   description MLAG_pod3-leaf-4_Port-Channel49
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 100.100.0.141/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.100.1.141/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 100.100.0.141/32
!
interface Loopback1
   description VXLAN_TUNNEL_SOURCE
   no shutdown
   ip address 10.100.1.141/32
!
...
| Vlan3009 |  VRF10  |  10.255.1.180/31  |  -  |  -  |  -  |  -  |
| Vlan3010 |  VRF11  |  10.255.1.180/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.1.180/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.1.148/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.1.181 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.253.40 | 65152 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.253.42 | 65152 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.255.1.181 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.1.181 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 100.100.0.141:10011 | 10011:10011 | - | - | learned |
| 12 | 100.100.0.141:10012 | 10012:10012 | - | - | learned |
| 21 | 100.100.0.141:10021 | 10021:10021 | - | - | learned |
| 22 | 100.100.0.141:10022 | 10022:10022 | - | - | learned |
| 3401 | 100.100.0.141:13401 | 13401:13401 | - | - | learned |
| 3402 | 100.100.0.141:13402 | 13402:13402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| VRF10 | 100.100.0.141:10 | connected | - |
| VRF11 | 100.100.0.141:11 | connected | - |
...
router bgp 65106
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description pod3-leaf-4
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER password 7 <removed>
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 10.255.1.181 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.1.181 description pod3-leaf-4_Vlan4093
   neighbor 10.255.253.40 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.253.40 remote-as 65152
   neighbor 10.255.253.40 description pod3-spine-1_Ethernet13
   neighbor 10.255.253.42 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.253.42 remote-as 65152
   neighbor 10.255.253.42 description pod3-spine-2_Ethernet13
   ...
   !
   vlan 11
      rd 100.100.0.141:10011
      route-target both 10011:10011
      redistribute learned
   !
   vlan 12
      rd 100.100.0.141:10012
      route-target both 10012:10012
      redistribute learned
   !
   vlan 21
      rd 100.100.0.141:10021
      route-target both 10021:10021
      redistribute learned
   !
   vlan 22
      rd 100.100.0.141:10022
      route-target both 10022:10022
      redistribute learned
   !
   vlan 3401
      rd 100.100.0.141:13401
      route-target both 13401:13401
      redistribute learned
   !
   vlan 3402
      rd 100.100.0.141:13402
   ...
   vrf VRF10
      ...
      router-id 100.100.0.141
      neighbor 10.255.1.181 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.181 description pod3-leaf-4_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 100.100.0.141
      neighbor 10.255.1.181 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.181 description pod3-leaf-4_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
