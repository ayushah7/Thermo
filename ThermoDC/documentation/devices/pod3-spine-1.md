...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_super-spine-1_Ethernet5 | - | 10.255.250.17/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_super-spine-2_Ethernet5 | - | 10.255.250.19/31 | default | 1500 | False | - | - |
| Ethernet11 | P2P_pod3-leaf-1_Ethernet1 | - | 10.255.253.32/31 | default | 1500 | False | - | - |
| Ethernet12 | P2P_pod3-leaf-2_Ethernet1 | - | 10.255.253.36/31 | default | 1500 | False | - | - |
| Ethernet13 | P2P_pod3-leaf-3_Ethernet1 | - | 10.255.253.40/31 | default | 1500 | False | - | - |
| Ethernet14 | P2P_pod3-leaf-4_Ethernet1 | - | 10.255.253.44/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 100.100.0.5/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.250.16 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.250.18 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.253.33 | 65105 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.253.37 | 65105 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.253.41 | 65106 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.253.45 | 65106 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65152
   ...
   neighbor 10.255.250.16 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.250.16 remote-as 65000
   neighbor 10.255.250.16 description super-spine-1_Ethernet5
   neighbor 10.255.250.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.250.18 remote-as 65000
   neighbor 10.255.250.18 description super-spine-2_Ethernet5
   neighbor 10.255.253.33 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.253.33 remote-as 65105
   neighbor 10.255.253.33 description pod3-leaf-1_Ethernet1
   neighbor 10.255.253.37 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.253.37 remote-as 65105
   neighbor 10.255.253.37 description pod3-leaf-2_Ethernet1
   neighbor 10.255.253.41 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.253.41 remote-as 65106
   neighbor 10.255.253.41 description pod3-leaf-3_Ethernet1
   neighbor 10.255.253.45 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.253.45 remote-as 65106
   neighbor 10.255.253.45 description pod3-leaf-4_Ethernet1
