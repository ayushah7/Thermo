...
| --------- | --------------- | ------------ | --------- |
| POD1_MLAG03 | Vlan4094 | 10.255.1.9 | Port-Channel49 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | MLAG_pod1-leaf-6_Ethernet49 | *trunk | *- | *- | *MLAG | 49 |
| Ethernet50 | MLAG_pod1-leaf-6_Ethernet50 | *trunk | *- | *- | *MLAG | 49 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_pod1-spine-1_Ethernet7 | - | 10.255.255.17/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_pod1-spine-2_Ethernet7 | - | 10.255.255.19/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_pod1-spine-1_Ethernet7
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_pod1-spine-2_Ethernet7
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet49
   description MLAG_pod1-leaf-6_Ethernet49
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description MLAG_pod1-leaf-6_Ethernet50
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | MLAG_pod1-leaf-6_Port-Channel49 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel49
   description MLAG_pod1-leaf-6_Port-Channel49
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 100.100.1.5/32 |
...
| Vlan3009 |  VRF10  |  10.255.2.8/31  |  -  |  -  |  -  |  -  |
| Vlan3010 |  VRF11  |  10.255.2.8/31  |  -  |  -  |  -  |  -  |
...
| 10.255.255.16 | 65150 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.255.18 | 65150 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.255.2.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.2.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 100.100.1.5:10011 | 10011:10011 | - | - | learned |
| 12 | 100.100.1.5:10012 | 10012:10012 | - | - | learned |
| 21 | 100.100.1.5:10021 | 10021:10021 | - | - | learned |
| 22 | 100.100.1.5:10022 | 10022:10022 | - | - | learned |
| 3401 | 100.100.1.5:13401 | 13401:13401 | - | - | learned |
| 3402 | 100.100.1.5:13402 | 13402:13402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| VRF10 | 100.100.1.5:10 | connected | - |
| VRF11 | 100.100.1.5:11 | connected | - |
...
router bgp 65103
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description pod1-leaf-6
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER password 7 <removed>
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 10.255.2.9 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.2.9 description pod1-leaf-6_Vlan4093
   neighbor 10.255.255.16 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.16 remote-as 65150
   neighbor 10.255.255.16 description pod1-spine-1_Ethernet7
   neighbor 10.255.255.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.18 remote-as 65150
   neighbor 10.255.255.18 description pod1-spine-2_Ethernet7
   ...
   !
   vlan 11
      rd 100.100.1.5:10011
      route-target both 10011:10011
      redistribute learned
   !
   vlan 12
      rd 100.100.1.5:10012
      route-target both 10012:10012
      redistribute learned
   !
   vlan 21
      rd 100.100.1.5:10021
      route-target both 10021:10021
      redistribute learned
   !
   vlan 22
      rd 100.100.1.5:10022
      route-target both 10022:10022
      redistribute learned
   !
   vlan 3401
      rd 100.100.1.5:13401
      route-target both 13401:13401
      redistribute learned
   !
   vlan 3402
      rd 100.100.1.5:13402
   ...
   vrf VRF10
      ...
      router-id 100.100.1.5
      neighbor 10.255.2.9 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.2.9 description pod1-leaf-6_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 100.100.1.5
      neighbor 10.255.2.9 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.2.9 description pod1-leaf-6_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
