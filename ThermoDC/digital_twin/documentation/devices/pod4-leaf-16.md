...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.168.0.94/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| POD4_MLAG08 | Vlan4094 | 10.255.7.28 | Port-Channel49 |
...
!
mlag configuration
   domain-id POD4_MLAG08
   local-interface Vlan4094
   peer-address 10.255.7.28
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | MLAG_pod4-leaf-15_Ethernet49 | *trunk | *- | *- | *MLAG | 49 |
| Ethernet50 | MLAG_pod4-leaf-15_Ethernet50 | *trunk | *- | *- | *MLAG | 49 |
...
interface Ethernet49
   description MLAG_pod4-leaf-15_Ethernet49
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description MLAG_pod4-leaf-15_Ethernet50
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | MLAG_pod4-leaf-15_Port-Channel49 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel49
   description MLAG_pod4-leaf-15_Port-Channel49
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 100.100.4.16/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.100.4.15/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 100.100.4.16/32
!
interface Loopback1
   description VXLAN_TUNNEL_SOURCE
   no shutdown
   ip address 10.100.4.15/32
!
...
| Vlan3009 |  VRF10  |  10.255.8.29/31  |  -  |  -  |  -  |  -  |
| Vlan3010 |  VRF11  |  10.255.8.29/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.8.29/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.7.29/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.8.28 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 10.255.8.28 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.8.28 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 100.100.4.16:10011 | 10011:10011 | - | - | learned |
| 12 | 100.100.4.16:10012 | 10012:10012 | - | - | learned |
| 21 | 100.100.4.16:10021 | 10021:10021 | - | - | learned |
| 22 | 100.100.4.16:10022 | 10022:10022 | - | - | learned |
| 3401 | 100.100.4.16:13401 | 13401:13401 | - | - | learned |
| 3402 | 100.100.4.16:13402 | 13402:13402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| VRF10 | 100.100.4.16:10 | connected | - |
| VRF11 | 100.100.4.16:11 | connected | - |
...
router bgp 65116
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description pod4-leaf-15
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER password 7 <removed>
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 10.255.8.28 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.8.28 description pod4-leaf-15_Vlan4093
   ...
   !
   vlan 11
      rd 100.100.4.16:10011
      route-target both 10011:10011
      redistribute learned
   !
   vlan 12
      rd 100.100.4.16:10012
      route-target both 10012:10012
      redistribute learned
   !
   vlan 21
      rd 100.100.4.16:10021
      route-target both 10021:10021
      redistribute learned
   !
   vlan 22
      rd 100.100.4.16:10022
      route-target both 10022:10022
      redistribute learned
   !
   vlan 3401
      rd 100.100.4.16:13401
      route-target both 13401:13401
      redistribute learned
   !
   vlan 3402
      rd 100.100.4.16:13402
   ...
   vrf VRF10
      ...
      router-id 100.100.4.16
      neighbor 10.255.8.28 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.8.28 description pod4-leaf-15_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 100.100.4.16
      neighbor 10.255.8.28 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.8.28 description pod4-leaf-15_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
