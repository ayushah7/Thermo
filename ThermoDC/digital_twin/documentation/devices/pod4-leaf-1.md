...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.168.0.79/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| POD4_MLAG01 | Vlan4094 | 10.255.7.1 | Port-Channel49 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_pod4-spine-1_Ethernet3 | - | 10.255.252.1/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_pod4-spine-2_Ethernet3 | - | 10.255.252.3/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_pod4-spine-1_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_pod4-spine-2_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 100.100.4.1/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.100.4.1/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 100.100.4.1/32
!
interface Loopback1
   description VXLAN_TUNNEL_SOURCE
   no shutdown
   ip address 10.100.4.1/32
!
...
| Vlan3009 |  VRF10  |  10.255.8.0/31  |  -  |  -  |  -  |  -  |
| Vlan3010 |  VRF11  |  10.255.8.0/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.8.0/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.7.0/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.8.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.252.0 | 65153 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.252.2 | 65153 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.255.8.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.8.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 100.100.4.1:10011 | 10011:10011 | - | - | learned |
| 12 | 100.100.4.1:10012 | 10012:10012 | - | - | learned |
| 21 | 100.100.4.1:10021 | 10021:10021 | - | - | learned |
| 22 | 100.100.4.1:10022 | 10022:10022 | - | - | learned |
| 3401 | 100.100.4.1:13401 | 13401:13401 | - | - | learned |
| 3402 | 100.100.4.1:13402 | 13402:13402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| VRF10 | 100.100.4.1:10 | connected | - |
| VRF11 | 100.100.4.1:11 | connected | - |
...
router bgp 65109
   ...
   neighbor 10.255.8.1 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.8.1 description pod4-leaf-2_Vlan4093
   neighbor 10.255.252.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.252.0 remote-as 65153
   neighbor 10.255.252.0 description pod4-spine-1_Ethernet3
   neighbor 10.255.252.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.252.2 remote-as 65153
   neighbor 10.255.252.2 description pod4-spine-2_Ethernet3
   ...
   !
   vlan 11
      rd 100.100.4.1:10011
      route-target both 10011:10011
      redistribute learned
   !
   vlan 12
      rd 100.100.4.1:10012
      route-target both 10012:10012
      redistribute learned
   !
   vlan 21
      rd 100.100.4.1:10021
      route-target both 10021:10021
      redistribute learned
   !
   vlan 22
      rd 100.100.4.1:10022
      route-target both 10022:10022
      redistribute learned
   !
   vlan 3401
      rd 100.100.4.1:13401
      route-target both 13401:13401
      redistribute learned
   !
   vlan 3402
      rd 100.100.4.1:13402
   ...
   vrf VRF10
      ...
      router-id 100.100.4.1
      neighbor 10.255.8.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.8.1 description pod4-leaf-2_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 100.100.4.1
      neighbor 10.255.8.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.8.1 description pod4-leaf-2_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
