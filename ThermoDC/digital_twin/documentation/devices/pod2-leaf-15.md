...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.168.0.57/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| POD2_MLAG08 | Vlan4094 | 10.255.3.29 | Port-Channel49 |
...
!
mlag configuration
   domain-id POD2_MLAG08
   local-interface Vlan4094
   peer-address 10.255.3.29
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | MLAG_pod2-leaf-16_Ethernet49 | *trunk | *- | *- | *MLAG | 49 |
| Ethernet50 | MLAG_pod2-leaf-16_Ethernet50 | *trunk | *- | *- | *MLAG | 49 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_pod2-spine-1_Ethernet17 | - | 10.255.254.57/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_pod2-spine-2_Ethernet17 | - | 10.255.254.59/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_pod2-spine-1_Ethernet17
   no shutdown
   mtu 1500
   no switchport
   ip address 10.255.254.57/31
!
interface Ethernet2
   description P2P_pod2-spine-2_Ethernet17
   no shutdown
   mtu 1500
   no switchport
   ip address 10.255.254.59/31
!
interface Ethernet49
   description MLAG_pod2-leaf-16_Ethernet49
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description MLAG_pod2-leaf-16_Ethernet50
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | MLAG_pod2-leaf-16_Port-Channel49 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel49
   description MLAG_pod2-leaf-16_Port-Channel49
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 100.100.2.15/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.100.2.15/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 100.100.2.15/32
!
interface Loopback1
   description VXLAN_TUNNEL_SOURCE
   no shutdown
   ip address 10.100.2.15/32
!
...
| Vlan3009 |  VRF10  |  10.255.4.28/31  |  -  |  -  |  -  |  -  |
| Vlan3010 |  VRF11  |  10.255.4.28/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.4.28/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.3.28/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.4.29 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.254.56 | 65151 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.254.58 | 65151 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.255.4.29 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.4.29 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 100.100.2.15:10011 | 10011:10011 | - | - | learned |
| 12 | 100.100.2.15:10012 | 10012:10012 | - | - | learned |
| 21 | 100.100.2.15:10021 | 10021:10021 | - | - | learned |
| 22 | 100.100.2.15:10022 | 10022:10022 | - | - | learned |
| 3401 | 100.100.2.15:13401 | 13401:13401 | - | - | learned |
| 3402 | 100.100.2.15:13402 | 13402:13402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| VRF10 | 100.100.2.15:10 | connected | - |
| VRF11 | 100.100.2.15:11 | connected | - |
...
router bgp 65140
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description pod2-leaf-16
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER password 7 <removed>
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 10.255.4.29 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.4.29 description pod2-leaf-16_Vlan4093
   neighbor 10.255.254.56 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.254.56 remote-as 65151
   neighbor 10.255.254.56 description pod2-spine-1_Ethernet17
   neighbor 10.255.254.58 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.254.58 remote-as 65151
   neighbor 10.255.254.58 description pod2-spine-2_Ethernet17
   ...
   !
   vlan 11
      rd 100.100.2.15:10011
      route-target both 10011:10011
      redistribute learned
   !
   vlan 12
      rd 100.100.2.15:10012
      route-target both 10012:10012
      redistribute learned
   !
   vlan 21
      rd 100.100.2.15:10021
      route-target both 10021:10021
      redistribute learned
   !
   vlan 22
      rd 100.100.2.15:10022
      route-target both 10022:10022
      redistribute learned
   !
   vlan 3401
      rd 100.100.2.15:13401
      route-target both 13401:13401
      redistribute learned
   !
   vlan 3402
      rd 100.100.2.15:13402
   ...
   vrf VRF10
      ...
      router-id 100.100.2.15
      neighbor 10.255.4.29 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.4.29 description pod2-leaf-16_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 100.100.2.15
      neighbor 10.255.4.29 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.4.29 description pod2-leaf-16_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
