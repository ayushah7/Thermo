...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.168.0.46/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| POD2_MLAG02 | Vlan4094 | 10.255.3.4 | Port-Channel49 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | MLAG_pod2-leaf-3_Ethernet49 | *trunk | *- | *- | *MLAG | 49 |
| Ethernet50 | MLAG_pod2-leaf-3_Ethernet50 | *trunk | *- | *- | *MLAG | 49 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_pod2-spine-1_Ethernet6 | - | 10.255.254.13/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_pod2-spine-2_Ethernet6 | - | 10.255.254.15/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_pod2-spine-1_Ethernet6
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_pod2-spine-2_Ethernet6
   no shutdown
   mtu 1500
   no switchport
   ip address 10.255.254.15/31
!
interface Ethernet49
   description MLAG_pod2-leaf-3_Ethernet49
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description MLAG_pod2-leaf-3_Ethernet50
   no shutdown
   channel-group 49 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel49 | MLAG_pod2-leaf-3_Port-Channel49 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel49
   description MLAG_pod2-leaf-3_Port-Channel49
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 100.100.2.4/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.100.2.3/32 |
...
| Vlan3009 |  VRF10  |  10.255.4.5/31  |  -  |  -  |  -  |  -  |
| Vlan3010 |  VRF11  |  10.255.4.5/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.4.5/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.3.5/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.4.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.254.12 | 65151 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.254.14 | 65151 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.255.4.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.4.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 100.100.2.4:10011 | 10011:10011 | - | - | learned |
| 12 | 100.100.2.4:10012 | 10012:10012 | - | - | learned |
| 21 | 100.100.2.4:10021 | 10021:10021 | - | - | learned |
| 22 | 100.100.2.4:10022 | 10022:10022 | - | - | learned |
| 3401 | 100.100.2.4:13401 | 13401:13401 | - | - | learned |
| 3402 | 100.100.2.4:13402 | 13402:13402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| VRF10 | 100.100.2.4:10 | connected | - |
| VRF11 | 100.100.2.4:11 | connected | - |
...
router bgp 65134
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description pod2-leaf-3
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER password 7 <removed>
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 10.255.4.4 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.4.4 description pod2-leaf-3_Vlan4093
   neighbor 10.255.254.12 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.254.12 remote-as 65151
   neighbor 10.255.254.12 description pod2-spine-1_Ethernet6
   neighbor 10.255.254.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.254.14 remote-as 65151
   neighbor 10.255.254.14 description pod2-spine-2_Ethernet6
   ...
   !
   vlan 11
      rd 100.100.2.4:10011
      route-target both 10011:10011
      redistribute learned
   !
   vlan 12
      rd 100.100.2.4:10012
      route-target both 10012:10012
      redistribute learned
   !
   vlan 21
      rd 100.100.2.4:10021
      route-target both 10021:10021
      redistribute learned
   !
   vlan 22
      rd 100.100.2.4:10022
      route-target both 10022:10022
      redistribute learned
   !
   vlan 3401
      rd 100.100.2.4:13401
      route-target both 13401:13401
      redistribute learned
   !
   vlan 3402
      rd 100.100.2.4:13402
   ...
   vrf VRF10
      ...
      router-id 100.100.2.4
      neighbor 10.255.4.4 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.4.4 description pod2-leaf-3_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 100.100.2.4
      neighbor 10.255.4.4 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.4.4 description pod2-leaf-3_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
