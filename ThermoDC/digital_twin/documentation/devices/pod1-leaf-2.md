...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 100.100.1.2/32 |
...
| Vlan3009 |  VRF10  |  10.255.2.1/31  |  -  |  -  |  -  |  -  |
| Vlan3010 |  VRF11  |  10.255.2.1/31  |  -  |  -  |  -  |  -  |
...
| 10.255.2.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.2.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 100.100.1.2:10011 | 10011:10011 | - | - | learned |
| 12 | 100.100.1.2:10012 | 10012:10012 | - | - | learned |
| 21 | 100.100.1.2:10021 | 10021:10021 | - | - | learned |
| 22 | 100.100.1.2:10022 | 10022:10022 | - | - | learned |
| 3401 | 100.100.1.2:13401 | 13401:13401 | - | - | learned |
| 3402 | 100.100.1.2:13402 | 13402:13402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| VRF10 | 100.100.1.2:10 | connected | - |
| VRF11 | 100.100.1.2:11 | connected | - |
...
router bgp 65101
   ...
   neighbor 10.255.2.0 description pod1-leaf-1_Vlan4093
   ...
   !
   vlan 11
      rd 100.100.1.2:10011
      route-target both 10011:10011
      redistribute learned
   !
   vlan 12
      rd 100.100.1.2:10012
      route-target both 10012:10012
      redistribute learned
   !
   vlan 21
      rd 100.100.1.2:10021
      route-target both 10021:10021
      redistribute learned
   !
   vlan 22
      rd 100.100.1.2:10022
      route-target both 10022:10022
      redistribute learned
   !
   vlan 3401
      rd 100.100.1.2:13401
      route-target both 13401:13401
      redistribute learned
   !
   vlan 3402
      rd 100.100.1.2:13402
   ...
   vrf VRF10
      ...
      router-id 100.100.1.2
      neighbor 10.255.2.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.2.0 description pod1-leaf-1_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 100.100.1.2
      neighbor 10.255.2.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.2.0 description pod1-leaf-1_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
